workspace "skygfx_vc"
   ...
   prebuildcommands {
	...
	"\"%DXSDK_DIR%/Utilities/bin/x86/fxc.exe\" /T vs_2_0 /nologo /E mainVS /Fo ../resources/release/vehiclePass1VS.cso ../shaders/pvs/vehiclePass1VS.hlsl",
	"\"%DXSDK_DIR%/Utilities/bin/x86/fxc.exe\" /T vs_2_0 /nologo /E mainVS /Fo ../resources/release/vehiclePass2VS.cso ../shaders/pvs/vehiclePass2VS.hlsl"
   }
